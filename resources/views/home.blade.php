	...
	<div class="container">
		<div class="w3-agileits-about-grids">
			<div class="col-md-6 agile-about-left">
				...
				<h5>Situs Ranking Sekolah Unggulan</h5>
				<p>Ranking Sekolah Unggulan adalah sebuah website yang menampilkan ranking serta perbandingan sekolah (SMA Sederajat). <span>Website ini diharapkan dapat membantu kalangan masyarakat untuk melihat perbandingan sekolah unggulan agar  para orangtua dan calon siswa dapat melihat sekolah-sekolah unggulan yang akan didaftarinya</span> Dengan adanya situs ini juga bisa menjadi acuan bagi sekolah yang ada untuk berlomba dalam memperbaiki Mutu Pendidikan didunia pendidikan.</p>
			</div>
		...
		<div class="w3agile-contact">
			<div class="col-md-5 col-sm-5 col-xs-6 w3_agileits-contact-left">
				...
				<div class="wthree-address">
					...
					<div class="col-md-10 col-sm-11 col-xs-11  w3_agile-contact-text">
						<h5>email</h5>
						<a href="mailto:spk_codeigniter@mial.com">spk_codeigniter@mial.com</a>
					</div>
					<div class="clearfix"></div>
				</div>		
				<div class="clearfix"></div>
